...
const data = [
	{
		...
		title: 'Proyecto 1',
		tegnology: [
			{ id: 1, name: 'React', icon: iconReact },
			{ id: 2, name: 'TailwindCSS', icon: iconTailwindCSS }
		],
		description: 'Descripción del proyecto 1',
		repository: [{ url: 'https://github.com', icon: iconGithub }],
		website: [{ url: 'https://www.google.com', icon: iconBrowser }]
	},
	{
		id: 2,
		image: 'https://porfolio.dev/projects/svgl.webp',
					...
					({
						...
						return (
							<li
								...
								<div className='h-56'>
									<img
										className='h-56 w-full rounded-2xl object-cover object-top transition duration-500 sm:h-full md:scale-110 md:hover:absolute md:hover:z-10 md:hover:flex md:hover:size-[550px] md:hover:scale-105'
										src={image}
										alt={title}
									/>
								</div>
								<div className='grid place-content-center items-center justify-items-center space-y-2'>
									<h3 className='text-center text-3xl md:text-start'>
										{title}
									</h3>
